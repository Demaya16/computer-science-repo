...
#include <stddef.h>
/**
* This function attempts to download a webpage from a given URL. If it succeeds,
it returns a
* pointer to a new string containing the contents of the webpage and sets the
value at size_out to
